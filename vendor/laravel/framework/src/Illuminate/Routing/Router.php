...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        $this->post('registerUser', 'Auth\RegisterController@registerUser')->name('registerUser');;
        $this->post('registerCompany', 'Auth\RegisterController@registerCompany')->name('registerCompany');;
